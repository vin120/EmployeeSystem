...
$(function(){
	...
	<div class="col-sm-6" style="width:100%">
										<div class="tabbable">
											<ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab4">
                                                <li <?php echo $t==0?"class='active'":''?>>
													<a href="assessment_quarter?t=0">考核结果维护</a>
												</li>
												  <li <?php echo $t==1?"class='active'":''?>>
													<a href="assessment_quarter?t=1">考核结果查询</a>
												</li>
												<li>
                                    ...
                                    <h1>
                                        ...
                                        <small>
                                            ...
                                            <?php echo Yii::t('vcos','员工季度管理'); ?>
                                        </small>
                                    </h1>
                            </div><!-- /.page-header -->
													
														 <form id='member_list' class="form-horizontal" method="post" action="<?php echo Yii::app()->createUrl("Assessment/assessment_quarter");?>" autocomplete="off" >
										 		<?php if ($t==0){?>
  ...
  <tr>
    <td height="49">&nbsp;</td>
    <td><div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="form-field-2"><?php echo yii::t('vcos', '考核季度：')?></label>

										<div class="col-sm-9"  style="width:68%">
											<select class="form-control" id="form-field-select-1" name="season_of_assessment">
												<option selected='selected' value=""><?php echo yii::t('vcos', '全部')?></option>
												<?php foreach ($season_assessmentinfo as $k=>$v):?>				
																<option value="<?=$v['season_of_assessment']?>" <?=$v['season_of_assessment']==$season_of_assessment?"selected='selected'":'' ?>><?php echo yii::t('vcos', $v['season_of_assessment'])?></option>
																<?php endforeach;?>
															</select>
    ...
    <td></td>
		...
		<center>
											...
											&nbsp; &nbsp; &nbsp;
										  <a href="assessment_quarter">	<button class="btn" type="button" value="清空">
											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												<thead>
													...
													<th>  <label>
														...
														<th><?php echo yii::t('vcos', '考核季度')?>	</th>
												...
												<tbody>
													<?php foreach ($posts as $k=>$v):?>
														...
														<td>
														 ...
														 <td class="hidden-480">
                                                       	<?php echo yii::t('vcos',$v['season_of_assessment'])?>
                                                       ...
                                                       <td class="hidden-480">
														...
														<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
															...
															<button class="btn btn-xs btn-info" href="#modal-form" role="button"  data-toggle="modal" onclick="alertinfo('<?php echo  $v['department_id'].'/'.$v['post_id'].'/'.$v['cn_name'].'/'.$v['employee_code'].'/'.$v['season_of_assessment'].'/'.$v['score'].'/'.$v['bonus'].'/'.$v['remark']?>')">
	...
	<!-- 第二个div -->
		...
		<!-- --------------------------------------------- -->
			 ...
			 <form id='member_list1' class="form-horizontal" method="post" action="<?php echo Yii::app()->createUrl("Assessment/assessment_quarter");?>" autocomplete="off" >
										 		<?php if ($t==1){?>
										 			<input type='hidden' name='page' value="<?php echo $page;?>">
                                                       <input type='hidden' name='isPage' value="1">
			<table width="760">
  ...
  <tr>
    ...
    <td></td>
		...
		<center>
											...
											&nbsp; &nbsp; &nbsp;
										  <a href="assessment_quarter?t=1">	<button class="btn" type="button" value="清空">
												<i class="icon-undo bigger-110"></i>
												清空
											</button>
		  </a>
	...
	<div class="col-xs-12">
		...
		<!-- 第三个div -->
				<div id="inputresult" <?php echo $t==2?"class='tab-pane in active'":"class='tab-pane'" ?> style="height:2000px">
					...
					<form action="<?php echo $this->createUrl('/assessment/assessment_quarter/');?>" method="post" enctype="multipart/form-data">				              
							 <table >
							 <tr>
							<td  width='30%'></td>
							 <td height='70px' width='450px'>
							 <h2>季度考核导入</h2>
							 </td>
								...
								<td> <h3>模版下载</h3></td>
									...
									<tr>
								<td></td>
								<td>点击<a href="<?php echo $this->createUrl('/assessment/downfile?name=quarter');?>">这里</a>下载模版,如果不按照这个模版将不能正常倒入数据,<br/>请不要在其他地方乱涂乱画，以免影响数据导入</td>
									</tr>
									</table> 
								</form> 
					</div>
...
<form action="SeasonUpdate" method="post">
     	...
     	<label class="col-sm-3 control-label no-padding-right" for="form-field-2"><?php echo yii::t('vcos', '考核季度:')?></label>
										...
										<div class="col-sm-9"  style="width:68%">
											<select class="form-control" id="form-field-select-1" name="season_of_assessment">
												...
												<?php foreach ($season_assessmentinfo as $k=>$v):?>				
																<option value="<?=$v['season_of_assessment']?>" id="<?=$k?>c"><?php echo yii::t('vcos', $v['season_of_assessment'])?></option>
																<?php endforeach;?>
															</select>
...
?>
   ...
   <script src="<?php echo $theme_url; ?>/assets/js/jqPaginator.js"></script>
									...
									function alertinfo(post){
										...
										for(var i=0;i<<?php echo sizeof($season_assessmentinfo)?>;i++){
									                ...
									                buttons: [
									                    {
									                        ...
									                        click: function() {
									                        	  location.href="<?php echo Yii::app()->createUrl("Assessment/seasonUpdate");?>"+"?del_id="+$a;
									                            $( this ).dialog( "close" );
									                        }
									                    }
									                    ,
