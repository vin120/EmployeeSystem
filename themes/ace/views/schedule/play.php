...
<div class="main-container" id="main-container">
	...
	<div class="main-container-inner">
							...
							<div class="col-xs-12">
								<div class="table-responsive">
															...
															<div class="inline position-relative">
																...
																<ul
																	class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
                                                                            <?php if($canedit){?>
                                                                            <li>
																		<a href="#" id="<?php echo $row['role_id'];?>"
																		...
																		id="<?php echo $row['role_id'];?>" data-rel="tooltip"
									...
									<div class="center">
                                                    <?php if($canadd){?>
                                                    <a
											href="<?php echo Yii::app()->createUrl('Auth/role_add');?>"
											class="btn btn-xs"> <i
		...
		<!-- #dialog-confirm -->
		<form action="<?php echo Yii::app()->createUrl("Auth/role_edit");?>"
			method="post">
