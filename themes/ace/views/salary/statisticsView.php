...
<div class="tabbable">
    <ul id="myTab4"
        ...
        <li class="<?php if($table_type=='1') echo "active";?>"><a
            href="#table_middle_1" data-toggle="tab"> 各职务薪资统计(月度)</a></li>
        <li class="<?php if($table_type=='2') echo "active";?>"><a
            href="#table_middle_2" data-toggle="tab"> 各职务薪资统计(年度)</a></li>
        <li class="<?php if($table_type=='3') echo "active";?>"><a
            href="#table_middle_3" data-toggle="tab"> 各薪资项目统计(月度)</a></li>
        <li class="<?php if($table_type=='4') echo "active";?>"><a
            href="#table_middle_4" data-toggle="tab"> 各薪资项目统计(年度) </a></li>
    </ul>
</div>
<div class="tab-content">
        ...
        <form action="" method="post" id="form1">
            <div style="overflow: hidden; margin-top: 20px;">
                <div style="float: left;">
                    <span style="font-size: 20px;"> 年 </span> <select
                        style="width: 100px;"
                    ...
                    </select> <span style="font-size: 20px;"> 月 </span>
                ...
                <button style="margin-left: 10%;" value="搜索" name="soso"
                    ...
                    type="submit">
                    搜索 <i class="icon-search  bigger-110"> </i>
                </button>
            </div>
        </form>
            ...
            <table
                ...
                <?php
                    ...
                    <tr class="aaa" style="margin-top: 10px;">
                        ...
                        <td>工资汇总</td>
                        <?php
                                                                                                foreach ( $month_salary_tongji as $value ) {
    ...
    <div class="tab-pane   <?php if($table_type=='2') echo "active";?>"
        ...
        <form action="" method="post" id="form2">
            <div style="overflow: hidden; margin-top: 20px;">
                <div style="float: left;">
                    <span style="font-size: 20px;"> 工资年份 </span> <select
                        style="width: 100px;height: 34px;"
                        aria-controls="sample-table-2" size="1"
