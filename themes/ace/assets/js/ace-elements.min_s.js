...
(function(e, c) {
	...
	f.prototype.apply_settings = function() {
		...
		this.$element.after('<label class="file-label" data-title="'
				...
				+ '"><span class="file-name hidden" data-title="'
				+ this.settings.no_file
				+ '"></span>'
				+ (this.settings.no_icon ? '<i class="' + this.settings.no_icon
						+ '"></i>' : "")
				+ '<span class="title_text">'+ this.settings.no_file+'</span>'
				+ "</label>"
	...
	f.prototype.show_file_list = function(k) {
		...
		if (this.well_style) {
			...
			this.$label.find(".title_text").remove();
			//this.$label.find(".file-name").parent().parent().parent().find('.img_show>img').remove();
		...
		for (var p = 0; p < n.length; p++) {
			...
			if (!this.well_style) {
				...
				//this.$label.append('<span class="file-name" data-title="' + l
					//	+ '"><i class="' + m + '"></i></span>');
				this.$label.append('<span class="title_text">' + l
						+ '</span>');
				this.$label.append('<span class="file-name hidden" data-title="' + l
						+ '"></span>');
	...
	f.prototype.reset_input = function() {
		...
		//this.$label.find(".title_text").not(":first").remove();
	...
	var i = function(o) {
		...
		//var l = n.$label.find(".file-name:last").parent().parent().parent().find(".img_show");
