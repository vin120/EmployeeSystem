    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            // 上传按钮
             ...
             // 上传图片限制
                $upload_size = $statusBar.find('.upload_size'),
                ...
                if (val != state) {
                    ...
                    switch (val) {
                        ...
                        case 'ready':
                            ...
                            $upload_size.text('单张大小限制'+editor.getOpt('imageMaxSize')+'B。');
        ...
        getInsertList: function () {
            ...
            for (i = 0; i < this.imageList.length; i++) {
                ...
                //替换图片路径 使编辑器中能够正常显示图片，例：http://www.wap.com/../wap/eduitor->http://www.wap.com/eduitor
                var aa = data.url;
                var aa = aa.replace(/\/st/g,'');
                list.push({
                   //src: prefix + data.url,
                    src: prefix + aa,
