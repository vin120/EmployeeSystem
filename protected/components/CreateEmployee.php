...
//公司（2位）+部门（2位）+入职日期（20160308）+001（3位数）
class CreateEmployee
{
    ...
    {
        $sql_value = 'SELECT member_id FROM vcos_member ORDER BY member_id DESC LIMIT 1 ' ;
        $member_id_value = Yii::app()->m_db->createCommand($sql_value)->queryScalar();
