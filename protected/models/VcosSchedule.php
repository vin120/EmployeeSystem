 ...
 */
class VcosSchedule extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('schedule_code, schedule_name, depatment_code, schedule_status', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return VcosSchedule the static model class
	 */
