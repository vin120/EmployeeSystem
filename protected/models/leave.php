...
/**
 * This is the model class for table "vcos_leave".
 *
 * The followings are the available columns in table 'vcos_leave':
 * @property string $id
...
class leave extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('leave_code', 'length', 'max'=>32),
			array('leave_type', 'length', 'max'=>50),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, leave_code, leave_type', 'safe', 'on'=>'search'),
		);
	}
