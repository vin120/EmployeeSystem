...
/**
 * This is the model class for table "vcos_holiday_log".
 *
 * The followings are the available columns in table 'vcos_holiday_log':
 * @property string $id
 ...
 */
class holiday_log extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return holiday_log the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, employee_code, holiday_code, date_of_start, date_of_end, count_day, remark, status', 'safe', 'on'=>'search'),
		);
	}
