...
/**
 * This is the model class for table "vcos_contract".
 *
 * The followings are the available columns in table 'vcos_contract':
...
class contract extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('contract_code', 'length', 'max'=>32),
			array('contract_type', 'length', 'max'=>80),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('contract_id, contract_code, contract_type', 'safe', 'on'=>'search'),
		);
	}
